      ...
      <div className="flex gap-2 lg:gap-4 text-[10px] lg:text-sm">
        <div className="space-y-2 lg:space-y-3">
          <div className="">
            ...
            <div className="bg-[#FFFFFF]/10 h-8 lg:h-10 w-16 lg:w-fit rounded-[8px] p-[2px] lg:p-[10px] flex items-center lg:gap-2">
        ...
        <div className="space-y-3">
          <div className="">
            ...
            <div className="bg-[#B40D00] h-8 lg:h-10 w-full rounded-[8px] flex justify-center items-center mx-auto">
